...
Keyboard helpers: Space jumps, `g` or Right Arrow goes to the next scene, Left Arrow goes back, `p` pauses, `z` zooms, `t` twirls, `r` rockets, `c` chugs the train, and `l` lifts with the crane.
